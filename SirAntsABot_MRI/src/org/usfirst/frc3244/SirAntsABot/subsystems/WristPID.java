...
import org.usfirst.frc3244.SirAntsABot.commands.Wrist.WristJoyStick;
...
public class WristPID extends PIDSubsystem {
    ...
    public WristPID() {
        ...
        super("WristPID", 0.13, 0.001, 0.0);//0.13, 0.00, 0.0);
        ...
        getPIDController().setOutputRange(-.6, 1.0);
    ...
    public void my_Wrist_Hold_Position(){
    	//System.out.println(pot_Angle.get());
    	motor_Wrist.set(.1);
    	Robot.wristPID.setSetpoint(pot_Angle.get());
    	Robot.wristPID.enable();
    }
    public void my_Wrist_Hold_Position(double correction){
    	//System.out.println(pot_Angle.get());
    	motor_Wrist.set(.1);
    	Robot.wristPID.setSetpoint(pot_Angle.get()+correction);
    	Robot.wristPID.enable();
    }
