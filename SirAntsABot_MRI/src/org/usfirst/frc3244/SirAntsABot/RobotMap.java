...
public class RobotMap {
    ...
    public static final double WRIST_ANGLE_UNDER_LOWBAR = 10;
...
*/    
    ...
    public static void init() {
        ...
        wristPIDpot_Angle = new AnalogPotentiometer(1, 293.0, -63.4);//A preference would be great here
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
       ...
       seaLegsSeaLeg_Drive = new RobotDrive(nordicSeaLeg_Left, nordicSeaLeg_Right);
        //seaLegsSeaLeg_Drive = new RobotDrive(seaLegsMotor_Left, seaLegsMotor_Right);
