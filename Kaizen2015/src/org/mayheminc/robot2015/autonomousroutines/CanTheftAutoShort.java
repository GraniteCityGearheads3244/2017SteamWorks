 ...
 *
 */
public class CanTheftAutoShort extends CommandGroup {

	public  CanTheftAutoShort() {
		...
		addSequential(new DriveForDistance(0.0, 0.6, 0.0, 8000 /*16000*/, 0.0));  // 16000 in normal CanTheftAuto
