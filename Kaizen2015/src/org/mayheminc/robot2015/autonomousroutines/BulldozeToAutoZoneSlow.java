 ...
 *
 */
public class BulldozeToAutoZoneSlow extends CommandGroup {
    
    public  BulldozeToAutoZoneSlow() {
        ...
        if (Robot.PRACTICE_BOT) {
            addSequential(new DriveForDistance(0.0, 0.50, 0.0, 30000, 0.0));
    	} else {
        	addSequential(new DriveForDistanceWithDeceleration(0.0, 0.50, 0.0, 26000, 0.0, 3000));
        }
