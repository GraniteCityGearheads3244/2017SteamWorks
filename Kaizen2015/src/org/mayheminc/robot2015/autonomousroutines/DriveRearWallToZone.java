 ...
 * @author Ken Streeter
 */
public class DriveRearWallToZone extends CommandGroup {
    
    public DriveRearWallToZone() {
        ...
        if (Robot.PRACTICE_BOT) {
        	...
        	addSequential(new DriveForDistanceWithDeceleration(0.0, 0.50, 0.0, 30000, 0.0, 3000));
        }
