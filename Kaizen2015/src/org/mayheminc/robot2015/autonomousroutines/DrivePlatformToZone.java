 ...
 * @author Ken Streeter
 */
public class DrivePlatformToZone extends CommandGroup {
    
    public DrivePlatformToZone() {
        ...
        if (Robot.PRACTICE_BOT) {
            addSequential(new DriveForDistance(0.0, 0.50, 0.0, 20000, 0.0));
    	} else {
            addSequential(new DriveForDistance(0.0, 0.50, 0.0, 19000, 0.0));
        }
