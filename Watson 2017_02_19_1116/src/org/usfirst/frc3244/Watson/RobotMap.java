...
public class RobotMap {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driveTrainMotor_Left_Front.setFeedbackDevice(FeedbackDevice.CtreMagEncoder_Relative);
        driveTrainMotor_Left_Rear.setFeedbackDevice(FeedbackDevice.CtreMagEncoder_Relative);
        driveTrainMotor_Right_Front.setFeedbackDevice(FeedbackDevice.CtreMagEncoder_Relative);
        driveTrainMotor_Right_Rear.setFeedbackDevice(FeedbackDevice.CtreMagEncoder_Relative);
        
        
        driveTrainMotor_Left_Front.changeControlMode(TalonControlMode.Speed);
        driveTrainMotor_Left_Front.enableControl();
        driveTrainMotor_Left_Rear.changeControlMode(TalonControlMode.Speed);
        driveTrainMotor_Left_Rear.enableControl();
        driveTrainMotor_Right_Front.changeControlMode(TalonControlMode.Speed);
        driveTrainMotor_Right_Front.enableControl();
        driveTrainMotor_Right_Rear.changeControlMode(TalonControlMode.Speed);
        driveTrainMotor_Right_Rear.enableControl();
