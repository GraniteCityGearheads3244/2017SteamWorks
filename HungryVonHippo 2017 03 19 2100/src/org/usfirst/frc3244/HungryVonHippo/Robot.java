    ...
    public void updateSmartDashboard() {
        try {
            if (System.currentTimeMillis() > nextSmartDashboardUpdate) {
                ...
                SmartDashboard.putNumber("Gyro Fused", Utils.twoDecimalPlaces(Robot.drive.getHeading()));
                SmartDashboard.putNumber("Gyro Angle", Utils.twoDecimalPlaces(RobotMap.ahrs.getAngle()));
