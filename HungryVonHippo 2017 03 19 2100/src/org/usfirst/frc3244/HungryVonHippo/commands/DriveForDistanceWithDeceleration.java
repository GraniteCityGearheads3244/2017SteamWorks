...
public class DriveForDistanceWithDeceleration extends Command {
	 private double m_x;
	 private double m_y;
...
//	 limit the deceleration to 2 seconds
	 ...
	 public DriveForDistanceWithDeceleration(double x, double y, double rotation, double totalDistance, 
