...
public class OI {
   ...
   public InternalButton example;
    ...
    private void setUp_Controler_xBox_Driver(){
        ...
        povWest_xBox_Driver.whileHeld(new DriveTurnToHeaddingInTeleop());
        
        povEast_xBox_Driver = new JoystickPOVButton(xBox_Driver, JoystickPOVButton.EAST);
        povEast_xBox_Driver.whileHeld(new DriveTurnToHeaddingInTeleop());
    }
    ...
    private void setUp_Controler_xBox_CoDriver(){
        ...
        x_xBox_CoDriver.whileHeld(new Drive_Set_Gyro_Adjustment(-90.0));
