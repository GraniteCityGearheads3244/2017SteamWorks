...
public class OI {
    ...
    public OI() {
        ...
        y.whileHeld(new Winch_Jog(.5));
        y = new JoystickButton(xbox_1, 2);
        y.whileHeld(new Winch_Jog(1));
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        rb = new JoystickButton(xbox_1, 6);
        rb.whileHeld(new WristJogUp());
        lb = new JoystickButton(xbox_1, 5);
        lb.whileHeld(new WristJogDown());
        a = new JoystickButton(xbox_1, 1);
        a.whileHeld(new IntakeJog());
