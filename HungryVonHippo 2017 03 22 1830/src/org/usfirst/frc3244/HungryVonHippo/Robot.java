...
public class Robot extends IterativeRobot {
    ...
    private void setupAutomousChooser(){
        ...
        autonomousChooser.addObject("2: Peg Left", new Auto_02_1_Peg_Left());
        autonomousChooser.addObject("3: Peg Left Shoot Boiler", new Auto_02_2_Peg_Left_Shoot_Boiler());
        autonomousChooser.addObject("4: Peg Right Shoot Boiler", new Auto_01_2_Peg_Right_Shoot_Boiler());
    ...
    private void setupStartUpChooser(){
    	...
    	StartUpChooser.addObject("Nort 0", 0);
