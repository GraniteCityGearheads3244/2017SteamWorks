...
import org.usfirst.frc3244.HungryVonHippo.util.IOButton;
...
public class OI {
   ...
   public InternalButton example;
    ...
    private void setUp_Controler_xBox_Driver(){
        ...
        povNorth_xBox_Driver.whileHeld(new DriveTurnToSetpointInTeleop(0.0,0.0,0.0f));//DriveTurnToHeaddingInTeleop());
        
        povSouth_xBox_Driver = new JoystickPOVButton(xBox_Driver, JoystickPOVButton.SOUTH);
        povSouth_xBox_Driver.whileHeld(new DriveTurnToSetpointInTeleop(0.0,0.0,179.9f));//DriveTurnToHeaddingInTeleop());
        
        povWest_xBox_Driver = new JoystickPOVButton(xBox_Driver, JoystickPOVButton.WEST);
        povWest_xBox_Driver.whileHeld(new DriveTurnToSetpointInTeleop(0.0,0.0,-90.0f));//DriveTurnToHeaddingInTeleop());
        
        povEast_xBox_Driver = new JoystickPOVButton(xBox_Driver, JoystickPOVButton.EAST);
        povEast_xBox_Driver.whileHeld(new DriveTurnToSetpointInTeleop(0.0,0.0,90.0f));//DriveTurnToHeaddingInTeleop());
    }
    ...
    private void setUp_Controler_xBox_CoDriver(){
        ...
        x_xBox_CoDriver.whileHeld(new DriveForDistance(.5,0,0,1000,0.0));
    ...
    private void setUp_Controler_LaunchPad(){
    	...
    	btn1_launchPad.whenPressed(new Vision_Toggle_Front_Light());
    	
    	btn2_launchPad = new JoystickButton(launchPad, 2);
    	btn2_launchPad.whileHeld(new Locate_Pin());
    	
    	toggleSwitch_launchPad = new JoystickButton(launchPad, 7);
        toggleSwitch_launchPad.whenPressed(new DriveSwitchFOD(true));
        toggleSwitch_launchPad.whenReleased(new DriveSwitchFOD(false));
    	
    }
    
    private void setUp_SmartDashboard_Buttons(){
    	example = new InternalButton();
    	//example.whileHeld(new Locate_Pin());
