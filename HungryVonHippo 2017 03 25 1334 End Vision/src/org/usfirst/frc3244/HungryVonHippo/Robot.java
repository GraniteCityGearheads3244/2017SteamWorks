...
/**
 * Vision changes 
 * 	public UsbCamera camera_Right;
 * 	added Locate_Pin() to contain all the vision treading
 */
...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //NavX tech support suggested a delay after initializing the NavX
        Timer.delay(1);
    ...
    private void setupAutomousChooser(){
        ...
        autonomousChooser.addDefault("0: Reach Base Line ", new Auto_00_Reach_BaseLine());
        autonomousChooser.addObject("1: Peg Right:", new Auto_01_1_Peg_Right());
        autonomousChooser.addObject("2: Peg Right Shoot Boiler", new Auto_01_2_Peg_Right_Shoot_Boiler());
        autonomousChooser.addObject("3: Peg Left", new Auto_02_1_Peg_Left());
        autonomousChooser.addObject("4: Peg Left Shoot Boiler", new Auto_02_2_Peg_Left_Shoot_Boiler());
        autonomousChooser.addObject("5: Peg Middle", new Auto_03_1_Peg_Middle());
        autonomousChooser.addObject("6: Peg Middle Shoot Blue", new Auto_03_2_Peg_Middle_Shoot_Blue());
        autonomousChooser.addObject("7: Peg Middle Shoot Red", new Auto_03_3_Peg_Middle_Shoot_Red());
        //autonomousChooser.addObject("5: Blue High Goal Near Boiler", new Auto_05_Blue_Near_Boiler());
        //autonomousChooser.addObject("6: Blue High Goal Middel Boiler", new Auto_06());
        //autonomousChooser.addObject("7: Blue High Goal Far Boiler", new Auto_07());
        //autonomousChooser.addObject("8: Left Pin", new Auto_08());
        //autonomousChooser.addObject("9: Middel Pin", new Auto_09());
        //autonomousChooser.addObject("10: Right Pin", new Auto_10());
        //Add More Options
    ...
    public void updateSmartDashboard() {
        try {
            if (System.currentTimeMillis() > nextSmartDashboardUpdate) {
                ...
                SmartDashboard.putNumber("Robot Tilt", RobotMap.ahrs.getRoll());
