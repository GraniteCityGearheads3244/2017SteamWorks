...
import org.usfirst.frc3244.HungryVonHippo.GripPipeline;
...
public class Vision_hardware extends Subsystem {
    ...
    public void My_Start_USB_Camera_Right(){
    	DriverStation.reportError("Starting USB Camera.", false);
...
//	    visionThread = new VisionThread(camera_Right, new GripPipeline(), pipelineL -> {
...
//	    visionThread.start();
    ...
    public void My_Start_IP_Camera(){
    	DriverStation.reportError("Starting Axis Camera.", false);
    ...
    public void My_Left_Forward_Toggle(){
    	if(lights_Left_and_Forward.get() == Value.kForward){
    		lights_Left_and_Forward.set(Value.kOff);
    	}else{
    		lights_Left_and_Forward.set(Value.kForward);
    	}
