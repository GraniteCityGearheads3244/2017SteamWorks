...
public class OI {
   ...
   public InternalButton example;
    ...
    private void setUp_Controler_xBox_Driver(){
        ...
        //a_xBox_Driver.whileHeld(new IntakeJog());
        
        b_xBox_Driver = new JoystickButton(xBox_Driver, 2);
        b_xBox_Driver.whileHeld(new Winch_Jog(1));
        
        x_xBox_Driver = new JoystickButton(xBox_Driver, 3);
        //x_xBox_Driver.whileHeld(new CMD());
        
        y_xBox_Driver = new JoystickButton(xBox_Driver, 4);
        y_xBox_Driver.whileHeld(new Winch_Jog(.5));
        ...
        //reset_xBox_Driver.whenPressed(new CMD());
        
        start_xBox_Driver = new JoystickButton(xBox_Driver, 8);
        //start_xBox_Driver.whileHeld(new Deliver_Fuel());
        
        rt_xBox_Driver = new JoystickAxisButton(xBox_Driver, 3);
        //rt_xBox_Driver.whileHeld(new Intake_Fuel());
    }
    ...
    private void setUp_Controler_xBox_CoDriver(){
        ...
        //a_xBox_CoDriver.whileHeld(new WristToSetpoit(90));
        
        b_xBox_CoDriver = new JoystickButton(xBox_CoDriver, 2);
        //b_xBox_CoDriver.whileHeld(new CMD());
        ...
        //y_xBox_CoDriver.whileHeld(new WristToSetpoit(0));
        
        lb_xBox_CoDriver = new JoystickButton(xBox_CoDriver, 5);
        //lb_xBox_CoDriver.whileHeld(new Elevator_Down());
        
        rb_xBox_CoDriver = new JoystickButton(xBox_CoDriver, 6);
        //rb_xBox_CoDriver.whileHeld(new Elevator_Up());
        ...
        //start_xBox_CoDriver.whileHeld(new CMD());
