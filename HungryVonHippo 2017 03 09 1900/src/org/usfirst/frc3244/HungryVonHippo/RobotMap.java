...
public class RobotMap {
	...
	static void init() { 
        ...
        LiveWindow.addSensor("Winch", "linitSwitch_Right", winchlimitSwitch_Right);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        flyWheelmotor_FlyWhell.setFeedbackDevice(FeedbackDevice.QuadEncoder);
        flyWheelmotor_FlyWhell.reverseSensor(true);
        flyWheelmotor_FlyWhell.configEncoderCodesPerRev(80);
        
        /* set the peak and nominal outputs, 12V means full */
        flyWheelmotor_FlyWhell.configNominalOutputVoltage(+0.0f, -0.0f);
        flyWheelmotor_FlyWhell.configPeakOutputVoltage(+12.0f, -0.0f);
        /* set closed loop gains in slot0 */
        flyWheelmotor_FlyWhell.setProfile(0);
        flyWheelmotor_FlyWhell.setF(8.52);
        flyWheelmotor_FlyWhell.setP(0);
        flyWheelmotor_FlyWhell.setI(0.0); 
        flyWheelmotor_FlyWhell.setD(0);
    	
        flyWheelmotor_FlyWhell.changeControlMode(TalonControlMode.Speed);
        flyWheelmotor_FlyWhell.setInverted(true);
