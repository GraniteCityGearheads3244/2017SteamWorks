...
public class RobotMap {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        boolean BeakMode = true;
        
        driveTrainMotor_Left_Front.enableBrakeMode(BeakMode);
        driveTrainMotor_Left_Rear.enableBrakeMode(BeakMode);
        driveTrainMotor_Right_Front.enableBrakeMode(BeakMode);
        driveTrainMotor_Right_Rear.enableBrakeMode(BeakMode);
        ...
        fuel_DeliveryMotor_Fuel_Flywheel.configNominalOutputVoltage(+12.0f, -0.0f);
        fuel_DeliveryMotor_Fuel_Flywheel.configPeakOutputVoltage(+12.0f, -0.0f);
        /* set closed loop gains in slot0 */
        fuel_DeliveryMotor_Fuel_Flywheel.setProfile(0);
        fuel_DeliveryMotor_Fuel_Flywheel.setF(0.1097);
        fuel_DeliveryMotor_Fuel_Flywheel.setP(0.02);
        fuel_DeliveryMotor_Fuel_Flywheel.setI(0.0); 
        fuel_DeliveryMotor_Fuel_Flywheel.setD(0);
