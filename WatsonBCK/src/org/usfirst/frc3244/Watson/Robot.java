...
import org.usfirst.frc3244.Watson.commands.Autonmous.AutonomousCommand;
...
public class Robot extends IterativeRobot {
    ...
    public static Fuel_Delivery fuel_Delivery;
    public static Winch winch;
    public static Fuel_Intake fuel_Intake;
    public static Gear_Lift gear_Lift;
    ...
    RobotMap.init();
        ...
        fuel_Delivery = new Fuel_Delivery();
        winch = new Winch();
        fuel_Intake = new Fuel_Intake();
        gear_Lift = new Gear_Lift();
    ...
    public void teleopPeriodic() {
        ...
        //driveTrain.mecanumDriveTeleop(oi.driveX(), oi.driveY(), oi.driveRotation()); 
        driveTrain.mecanumDriveTeleop(Robot.oi.xbox_1.getRawAxis(0), Robot.oi.xbox_1.getRawAxis(1), Robot.oi.xbox_1.getRawAxis(4)); 
