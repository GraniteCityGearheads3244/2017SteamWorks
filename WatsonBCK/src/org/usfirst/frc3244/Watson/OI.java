...
import org.usfirst.frc3244.Watson.OI;
import org.usfirst.frc3244.Watson.commands.*;
import org.usfirst.frc3244.Watson.commands.Drive.Drive_Robot_Robot_Field_Oriented_Mecanum;
...
////CREATING BUTTONS
   ...
   public InternalButton example;
    ...
    public boolean driveTurboMode() {
        return(false);//xbox_1.getRawButton(OI.GAMEPAD_F310_LEFT_BUTTON));
    }
    
    public boolean crawlBackward() {
        return(false);//xbox_1.getRawButton(OI.GAMEPAD_F310_A_BUTTON));
    }
    
    public boolean crawlForward() {
        return(false);//xbox_1.getRawButton(OI.GAMEPAD_F310_Y_BUTTON));
    }
    
    public boolean crawlLeft() {
        return(false);//xbox_1.getRawButton(OI.GAMEPAD_F310_X_BUTTON));
    }
    
    public boolean crawlRight() {
        return(false);//xbox_1.getRawButton(OI.GAMEPAD_F310_B_BUTTON));
    }
